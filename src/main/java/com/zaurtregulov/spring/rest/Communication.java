...
public class Communication {
    ...
    public Employee getEmployee(int employeeId) {
        ResponseEntity<Employee> responseEntity = restTemplate.exchange(
                URL + "/" + employeeId, HttpMethod.GET, null, new ParameterizedTypeReference<Employee>() {});
    ...
    public void saveEmployee(Employee employee) {
        ...
        if (employeeId == 0) {
            ...
            System.out.println("new employeer was added to database");
            System.out.println(responseEntity.getBody());
        } else {
            restTemplate.put(URL, employee);
            System.out.println("employeer with" + employee.getId() + " was updated");
        }
